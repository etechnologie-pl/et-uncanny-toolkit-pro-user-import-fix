...
class ImportLearndashUsersFromCsv extends toolkit\Config implements toolkit\RequiredFunctions {
    ...
    wp_enqueue_script( 'papaparse', 'https://cdnjs.cloudflare.com/ajax/libs/PapaParse/5.3.0/papaparse.min.js', array( 'jquery' ), '5.3.0', true );

		wp_enqueue_script( self::$module_key, $script_url, array( 'jquery', 'papaparse' ), UNCANNY_TOOLKIT_PRO_VERSION );
